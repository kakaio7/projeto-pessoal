...
switch(pergunta) {
  ...
  Poder de Ki: Eles possuem um aumento base de 30% em Poder de Ki e uma Reserva de Ki 20% maior, o que lhes confere vantagens em combate. 
      
  Longevidade: Namekuseijins tendem a viver muito mais tempo do que os humanos. 

  Habilidades Especiais: Além da regeneração, alguns Namekuseijins podem usar habilidades mágicas como a criação das Esferas do Dragão e outras habilidades relacionadas à cura. 

  Tamanho: Em média, os Namekuseijins têm entre 1,50 e 2 metros de altura. 
...
switch(pergunta){
  ...
  Longevidade: Apesar de não serem explicitamente imortais, Majins envelhecem muito lentamente e possuem grande resistência. 
     
  Poderes: Regeneração, absorção de energia e de outros seres, manipulação da matéria (podem se transformar em vários objetos) e técnicas de cura. 
...
switch(pergunta){
  ...
  Força: Possuem uma força natural impressionante, com os Kaios tendo níveis de poder altos e os Kaioshins sendo ainda mais fortes. 

  Magia: Demonstram afinidade com magia, como visto em Zamasu, que a utiliza de forma eficaz. 
...
switch(pergunta){
  ...
  Força Superior: Anjos possuem uma força que supera a dos deuses da destruição, sendo que o mais forte, Daishinkan, é considerado o guerreiro mais forte do multiverso. 

  Controle Temporal: Anjos podem manipular o tempo, revertendo danos causados por deuses da destruição ou utilizando-o para fins diversos. 

  Habilidades Extras: Além do controle temporal, anjos podem se teletransportar, materializar objetos, prever o futuro, curar, ressuscitar e manipular a matéria. 

  Instinto Superior: Anjos possuem o Instinto Superior completo e ativo, o que lhes permite se esquivar de ataques sem esforço. 

  Imortalidade: Anjos são imortais, mas podem ser eliminados se violarem as leis dos anjos, como lutar seriamente contra mortais.  
...
switch(pergunta){
  ...
  Atributos Iniciais: Arcosianos começam com 15 em Espírito e Constituição, mas têm Destreza e Mente em 5. 

  Modificadores: Recebem um bônus de 20% em Defesa, 10% em Vigor e 30% em Velocidade. 

  Transformações: Arcosianos podem se transformar para aumentar seu poder, com multiplicadores que variam de 2x (segunda forma) a 15x (forma de aumento). 
...
switch(pergunta){
  ...
  Tipos de Androides: Existem androides totalmente artificiais (como o 8 e o 16), androides com absorção de energia (como o 19 e o 20) e bio-androides (como o Cell).

  Poder e Habilidades: A força e as habilidades dos androides variam muito. Alguns, como o 17 e o 18, possuem força e velocidade incríveis, enquanto outros, como o 16, são notáveis por sua resistência.

  Imunidade ao Ki: Alguns androides, especialmente os totalmente artificiais, são imunes à detecção por rastreadores de Ki e podem até mesmo suprimir seu próprio Ki.

  Fontes de Energia: Alguns androides, como o 19 e o 20, precisam absorver energia para se manterem funcionando, enquanto outros, como o 17 e o 18, têm fontes de energia ilimitadas.
...
switch(pergunta){
  ...
  Estatísticas Gerais dos humanos: Humanos treinados como Mestre Kame, Krillin, Tien e Yamcha possuem.

  Força: Capazes de quebrar rochas ou levantar objetos pesados com facilidade.

  Velocidade: Superam a velocidade do som; Krillin chegou a voar mais rápido que o Jato de Bulma (~Mach 1.5)
